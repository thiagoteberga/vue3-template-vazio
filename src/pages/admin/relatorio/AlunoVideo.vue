<template>
  <admin-template>
    ...
    <span slot="breadcrumb-template">
          ...
          <router-link to="#" class="breadcrumb">Alunos x Vídeos Assistidos</router-link>
    </span>
          ...
          <div v-if="this.naoprocessado">
            <div class="input-field col s12">
              <div style="text-align:center">         
                <h3>Relatório</h3>
                <h5>Alunos x Vídeos Assistidos</h5>
                <hr>
          ...
          <div class="center-align" v-else>
            <div>
              ...
              <vue-excel-xlsx
                  :data="data"
                  :columns="columns"
                  :filename="'Relatorio de Usuarios x Videos'"
                  :sheetname="'Relatorio'"
...
export default {
  ...
  methods: {
    ...
    gerar(){
      ...
      this.$http.get(this.$urlAPI+`relatorio/usuario/video/`+this.data_inicial+' 00:00:00/'+this.data_final+' 23:59:59',
