...
export default {
  ...
  methods: {
    atualizaPagina(){
      ...
      let videoAlterar = this.$store.getters.getVideoParticipativoEditById(idVideoAlterar);
      ...
      this.$http
        ...
        .then((response) => {
          ...
          if (response.data.status) {
            ...
            this.$router.push('/admin/video/participativo/cadastrar');
