      ...
      <card-edit-vue>
        <span slot="inputs">
          <div class="input-field col s12">
            ...
            <input v-for="colegio in usuario.colegio" :key="colegio.id" id="colegio" type="text" class="validate" maxlength="255" v-model="colegio.name" disabled>
            <label for="colegio" class="active">Colégio</label>
          </div>
          <div class="input-field col s12">
...
export default {
  ...
  data () {
    return {
    usuario:{id: '', name:'', cpf:'', email:'', password:'', password_confirmation:'', colegio:''}
    }
  },
  mounted () {
    M.AutoInit()
  ...
  methods: {
    atualizaPagina(){
      ...
      let usuarioAlterar = this.$store.getters.getUsuarioColegioById(idUsuarioAlterar);
      ...
      if(usuarioAlterar){
        ...
        this.usuario.colegio = usuarioAlterar.colegio;
      }
      ...
      this.$http
        ...
        .then((response) => {
          ...
          if (response.data.status) {
            ...
            this.$router.push('/admin/user-school/cadastrar');
